...
[![Version](https://img.shields.io/github/v/release/cachix/devenv?color=green&label=version&sort=semver)](https://github.com/Unity-Billal-mesloub/devenv/releases)
[![CI](https://github.com/Unity-Billal-mesloub/devenv/actions/workflows/release.yml/badge.svg)](https://github.com/Unity-Billal-mesloub/devenv/actions/workflows/release.yml?branch=main)
